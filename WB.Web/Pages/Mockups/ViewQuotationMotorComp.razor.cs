...
{
    public partial class ViewQuotationMotorComp : ComponentBase
    {
        ...
        public List<PremiumDetail> PremiumDetailsData { get; set; } = new List<PremiumDetail>
    {
        ...
        new PremiumDetail { FeeType = "Commission", Percentage = "10", Amount = "56.700" }
    };
        #endregion
        ...
        private async Task OpenReviewSubmitDialog()
        {
            await dialogService.Confirm("Are you sure you would like to approve the request for Quotation Request # 87452?",
                "Confirm",
