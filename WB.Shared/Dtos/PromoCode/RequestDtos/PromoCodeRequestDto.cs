...
{
    public class PromoCodeRequestDto : EntityBaseDto
    {
        ...
        public IList<PromoCodeSiteListRequestDto> PromoSitesToNotify { get; set; } = new List<PromoCodeSiteListRequestDto>();
        [NotMapped]
