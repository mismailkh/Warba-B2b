...
namespace WB.Admin.Pages.Mockups
{
        ...
        public List<PremiumDetail> PremiumDetailsData { get; set; } = new List<PremiumDetail>
    {
        ...
        private async Task OpenReviewSubmitDialog(string key)
        {
            await dialogService.Confirm($"Are you sure you would like to {key} the request for Quotation Request # 87452?",
                "Confirm",
                new ConfirmOptions() { OkButtonText = key, CancelButtonText = "Cancel" });
        }
    }
    #endregion
}